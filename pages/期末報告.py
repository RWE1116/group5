...
if page == "概論":
    ...
    """)
    # 插入圖片
    img_path = "Y:/a/downloads/期末報告1.png"
    ...
    """)
    img_path = "Y:/a/downloads/期末報告3.png"
    ...
    """)
    img_path = "Y:/a/downloads/期末報告4.png"
    display_image(img_path, "VK真空產生器", "VK真空產生器")
    img_path = "Y:/a/downloads/期末報告5.png"
    ...
    """)
    img_path = "Y:/a/downloads/期末報告6.png"
...
公司具備沖壓型、鋁擠型和表面處理等多種製造工藝，確保產品質量和性能達到行業領先水平。
    """)
    img_path = "Y:/a/downloads/期末報告7.png"
...
支援多樣化的尺寸與形狀定制，並可模組化集成到各類電子設備中，滿足不同應用需求。
    ...
    """)
    img_path = "Y:/a/downloads/期末報告11.png"
    ...
    Q = V1A1 = V2A2 = V3A3
    """)
    img_path = "Y:/a/downloads/期末報告12.png"
    display_image(img_path, "柏努力定理", "柏努力定理")
    
    st.markdown(""" 
    當流量固定,斷面截面積不同將造成不同的流速,以下分析三種斷面、流速及壓力情形:
    """)
    img_path = "Y:/a/downloads/期末報告13.png"
    display_image(img_path, "流速壓力比較表", "流速壓力比較表")
    
    st.markdown(""" 
    2. 依據原理與工件大小之零組件設計圖
    """)    
    img_path = "Y:/a/downloads/工程圖1.jpg"
    display_image(img_path, "零組件設計圖", "零組件設計圖")
    
    img_path = "Y:/a/downloads/生成器 1.png"  
    display_image(img_path, "生成器3D圖", "生成器3D圖")
    
    cols = st.columns(3)

    image_paths = [
        "Y:/a/downloads/生成器2.jpg", "Y:/a/downloads/生成器3.jpg", "Y:/a/downloads/生成器4.jpg",
    ]
    titles = ["排氣", "真空區", "進氣"]
    ...
    image_paths = [
        "Y:/a/downloads/散熱器 尺寸1.jpg", "Y:/a/downloads/散熱器 尺寸2.jpg", "Y:/a/downloads/散熱器 尺寸3.jpg","Y:/a/downloads/散熱器 尺寸4.jpg"
    ]
    ...
    img_path = "Y:/a/downloads/期末報告14.png"
    ...
    """)
    img_path = "Y:/a/downloads/期末報告15.png"
    ...
    img_path = "Y:/a/downloads/期末報告16.png"
    display_image(img_path, "三組設計", "三組設計參數計算結果")
    ...
    7.	紀錄跡線及數據
    """)   
    img_path = "Y:/a/downloads/期末報告17.png"
    display_image(img_path, "excel計算", "excel計算")
    img_path = "Y:/a/downloads/期末報告18.png"
...
1.依照Excel檔建立真空產生器與周邊3D設計圖(零件、組合、爆炸)
    ...
    """)
    img_path = "Y:/a/downloads/期末報告19.png"
    display_image(img_path, "記錄跡線及數據", "記錄跡線及數據")
    st.markdown("""
    3.	繪圖並討論數值模擬結果及計算書結果與數值模擬(CAE法)之誤差?
    """)    
    image_paths = [
        "Y:/a/downloads/期末報告21.png", "Y:/a/downloads/期末報告22.png"
    ]
    titles = ["期末考評分表", "計算過程"]
...
2.依照Excel檔建立散熱器計算書(公式法)
    ...
    """)
    img_path = "Y:/a/downloads/期末報告23.png"
    display_image(img_path, "記錄跡線及數據", "記錄跡線及數據")
    st.markdown("""
    3.	繪圖並討論數值模擬結果及計算書結果與數值模擬(CAE法)之誤差?
    """)
    img_path = "Y:/a/downloads/期末報告21.png"
...
成員簽名：
    """)
    image_paths = [
        "Y:/a/downloads/聲明1.jpg", "Y:/a/downloads/聲明2.jpg", "Y:/a/downloads/聲明3.jpg", "Y:/a/downloads/聲明4.jpg", "Y:/a/downloads/聲明5.jpg"
    ]
